...
Public Class LiqPropietDupl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AdmIn.LiqPropietDupl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_LiqPropietrpt_Prueba() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLiqPropietDupl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LiqPropietDupl = New LiqPropietDupl()
        rpt.Site = Me.Site
        Return rpt
    End Function
