...
Public Class LiqPropietAdlAut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AdmIn.LiqPropietAdlAut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLiqPropietAdlAut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LiqPropietAdlAut = New LiqPropietAdlAut()
        rpt.Site = Me.Site
        Return rpt
    End Function
