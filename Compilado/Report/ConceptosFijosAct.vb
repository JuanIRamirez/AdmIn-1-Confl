...
Public Class ConceptosFijosAct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AdmIn.ConceptosFijosAct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConceptosFijosAct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConceptosFijosAct = New ConceptosFijosAct()
        rpt.Site = Me.Site
        Return rpt
    End Function
