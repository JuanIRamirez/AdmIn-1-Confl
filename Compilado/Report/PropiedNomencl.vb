...
Public Class PropiedNomencl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AdmIn.PropiedNomencl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPropiedNomencl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PropiedNomencl = New PropiedNomencl()
        rpt.Site = Me.Site
        Return rpt
    End Function
