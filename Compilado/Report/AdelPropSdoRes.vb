...
Public Class AdelPropSdoRes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AdmIn.AdelPropSdoRes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdelPropSdoRes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AdelPropSdoRes = New AdelPropSdoRes()
        rpt.Site = Me.Site
        Return rpt
    End Function
