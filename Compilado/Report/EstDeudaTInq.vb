...
Public Class EstDeudaTInqRes
   ...
   Public Overrides Property FullResourceName() As String
      Get
         Return "AdmIn.EstDeudaTInqRes.rpt"
      End Get
      Set
         'Do nothing
      End Set
...
Public Class CachedEstDeudaTInqRes
   Inherits Component
   ...
   Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
      Dim rpt As EstDeudaTInqRes = New EstDeudaTInqRes()
      rpt.Site = Me.Site
      Return rpt
   End Function
