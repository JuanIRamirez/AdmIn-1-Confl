...
Public Class ResALiqPropRes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AdmIn.ResALiqPropRes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedResALiqPropRes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ResALiqPropRes = New ResALiqPropRes()
        rpt.Site = Me.Site
        Return rpt
    End Function
